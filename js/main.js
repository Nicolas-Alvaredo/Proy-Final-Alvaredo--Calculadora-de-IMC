    ...
    function mostrarFormularioIMC(cantidadPersonas) {
        ...
        botonEnviar.addEventListener("click", function () {
            ...
            if (camposCompletos) {
                ...
                mostrarDatosEnTabla(arrayPersonas);
    ...
    function mostrarDatosEnTabla(arrayPersonas) {
        ...
        arrayPersonas.forEach(persona => {
            ...
            fila.innerHTML = `
                ...
                <td>${persona.IMC.toFixed(1)}</td>
            `;
            tbody.appendChild(fila);
        });
        document.getElementById("listadoIMC").appendChild(tabla);
    }
